															...
															<td style="width:100%;padding-right:0px;padding-left:0px;">
																<div align="center" style="line-height:10px"><a
																		...
																		tabindex="-1" target="_blank"><img
																			alt="Your logo."
																			src="https://drive.google.com/uc?export=view&id=1XSL0RxjfwwmwX1E75mGdYSbePBpJCzmd"
															...
															<td style="width:100%;padding-right:0px;padding-left:0px;">
																<div align="center" style="line-height:10px"><a
																		...
																		tabindex="-1" target="_blank"><img
																			...
																			src="https://drive.google.com/uc?export=view&id=15fQ91hWzu3BBrRznm_BuGHu934kTmWrA"
														...
														<tr>
															<td
																...
																<div style="font-family: Arial, sans-serif">
																	<div
																		style="font-size: 12px; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #555555; line-height: 1.2;">
																		<p
																			style="margin: 0; font-size: 16px; text-align: center;">
																			<span
																				style="font-size:30px;color:#2b303a;"><strong>Forgot
																					Your Password?</strong></span></p>
																	</div>
																</div>
															</td>
														</tr>
															...
															<td
																...
																<div align="center">
																	<!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="www.example.com" style="height:62px;width:210px;v-text-anchor:middle;" arcsize="57%" stroke="false" fillcolor="#f7a50c"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#ffffff; font-family:Arial, sans-serif; font-size:16px"><![endif]--><a
																		href="{{url('/forgot_password/'.$rand_id)}}"
																		...
																		target="_blank"><span
																			style="padding-left:30px;padding-right:30px;font-size:16px;display:inline-block;letter-spacing:normal;"><span
																				style="font-size: 16px; margin: 0; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;"><strong>RESET
						...
						<tbody>
							<tr>
								<td>
									<table align="center" border="0" cellpadding="0" cellspacing="0"
										class="row-content stack" role="presentation"
										style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #410125;"
										width="640">
										<tbody>
											<tr>
												<th class="column"
														...
														<tr>
															<td style="width:100%;padding-right:0px;padding-left:0px;">
																<div align="center" style="line-height:10px"><a
																		...
																		tabindex="-1" target="_blank"><img
																			alt="Your logo. "
																			src="https://drive.google.com/uc?export=view&id=1FxqWwi8jRwS6SJNRFhS64LAdRR6GwvAK"
																	...
																	<tr>
																		<td style="padding:0 10px 0 10px;"><a
																				...
																				target="_blank"><img alt="Facebook"
																					height="32"
																					src="https://drive.google.com/uc?export=view&id=1A0AMEeQ3uWaQWntJQ-qfs_SAeha0ng9Q"
																		...
																		<td style="padding:0 10px 0 10px;"><a
																				...
																				target="_blank"><img alt="Twitter"
																					height="32"
																					src="https://drive.google.com/uc?export=view&id=1s0JpTKOM_4MnQlckvdduUs0oi2xpN4cL"
																					style="display: block; height: auto; border: 0;"
																		...
																		<td style="padding:0 10px 0 10px;"><a
																				...
																				target="_blank"><img alt="Instagram"
																					height="32"
																					src="https://drive.google.com/uc?export=view&id=1goSaLYGsMLp4B68o5VteJrY6DqG7NvRl"
																					style="display: block; height: auto; border: 0;"
																		...
																		<td style="padding:0 10px 0 10px;"><a
																				...
																				target="_blank"><img alt="LinkedIn"
																					height="32"
																					src="https://drive.google.com/uc?export=view&id=1LUFRqO4bTQk4CLSDtgMrkmCnZSK4J4ej"
																					style="display: block; height: auto; border: 0;"
																...
																<div style="font-family: sans-serif">
																	<div
																		...
																		<p
																			...
																			<span
																				style="color:#95979c;font-size:12px;">Fast Shop Copyright © 2021</span></p>
